...
static unsigned int GetNextTargetRequired_(const CBlockIndex* pindexLast, bool fProofOfStake)
{
    ...
    // Includes BoostCoin fix for wrong retargeting difficulty by Mammix2
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        const char* pszTimestamp = "moon...bitches....";
        CTransaction txNew;
        txNew.nTime = 1421358146;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        //// debug print
        assert(block.hashMerkleRoot == uint256("b7f609dffe1dcccb3387be0500132ecfc9e50d0933d4c042edcd255bad672019"));
        block.print();
...
unsigned char pchMessageStart[4] = { 0x72, 0x38, 0x21, 0x35 };
